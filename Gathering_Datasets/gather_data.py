...
def download_images_from_flickr(query, brand_folder, num_images=200, api_key=None, api_secret=None):
...
if __name__ == "__main__":
    ...
    for brand in brands:
        ...
        query = brand  
        download_images_from_unsplash(query, brand_folder, num_images=200, access_key=access_key)
        download_images_from_flickr(query, brand_folder, num_images=200, api_key=api_key, api_secret=api_secret)
